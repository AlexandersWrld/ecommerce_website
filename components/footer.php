<footer class="footer">
   ...
   <div class="box">
         ...
         <a href="mailto:shaikh@gmail.com"><i class="fas fa-envelope"></i> akb27@njit.edu</a>
         <a href=#><i class="fas fa-map-marker-alt"></i> Kingston, Jamaica </a>
      </div>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>Alexander K Boyd</span> | all rights reserved!</div>
